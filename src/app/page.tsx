    ...
    return (
      <section className="mb-16">
        <div className="w-fit mb-8">
          <h2 className="text-2xl font-semibold inline-block pb-1">Projects</h2>
          ...
          {projects.projects.map((project, index) => (
            ...
            >
              <motion.div
                whileHover={{ y: -5 }}
                whileTap={{ scale: 0.98 }}
                className="bg-zinc-800 rounded-lg overflow-hidden h-full transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10"
              >
                <div className="p-5">
  ...
  return (
    <main className="relative min-h-screen py-16 px-4 sm:px-8 md:px-16 lg:px-24 bg-zinc-900 text-white">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Work Experience & Projects Inside */}
        <section className="mb-16">
          <div className="w-fit mb-8">
            <h2 className="text-2xl font-semibold inline-block pb-1">
              Work Experience
        ...
        {/* Standalone Projects */}
        <AnimateInView>{renderProjects()}</AnimateInView>
